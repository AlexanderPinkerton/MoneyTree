...
export const schema = defineSchema({
  ...
  core: {
    ...
    OPENAI_ANALYSIS_MODEL: {
      default: "gpt-5-mini",
      description: "OpenAI model used for /biz/ post analysis",
    },
    OPENAI_ANALYSIS_BATCH_SIZE: {
      default: "60",
      description: "Maximum queued /biz/ AI jobs processed per worker tick",
    },
    OPENAI_ANALYSIS_CONCURRENCY: {
      default: "6",
      description: "Concurrent OpenAI requests for /biz/ AI analysis",
    },
    BIZ_TRIAGE_BATCH_SIZE: {
      default: "1000",
      description: "Maximum queued /biz/ triage jobs processed per worker pass",
    },
    BIZ_TRIAGE_CONCURRENCY: {
      default: "20",
      description: "Concurrent local /biz/ deterministic triage jobs",
    },
    ANTHROPIC_API_KEY: {
      default: "",
